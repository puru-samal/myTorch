...
class CNN_SimpleScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.conv1d_stride1.W = np.transpose(
            w1.T.reshape(8, 8, 24), (0, 2, 1))
        self.conv2.conv1d_stride1.W = np.transpose(
            w2.T.reshape(16, 1, 8), (0, 2, 1))
        self.conv3.conv1d_stride1.W = np.transpose(
            w3.T.reshape(4, 1, 16), (0, 2, 1))
...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.conv1d_stride1.W = np.transpose(
            w1[:48, :2].T.reshape(2, 2, 24), (0, 2, 1))
        self.conv2.conv1d_stride1.W = np.transpose(
            w2[:4, :8].T.reshape(8, 2, 2), (0, 2, 1))
        self.conv3.conv1d_stride1.W = np.transpose(
            w3.T.reshape(4, 2, 8), (0, 2, 1))
