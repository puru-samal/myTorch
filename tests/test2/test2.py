...
from mytorch.nn.pool import *
from mytorch.nn.resampling import *
from mytorch.nn.ConvTranspose import *
...
import mytorch.models.mlp_scan as cnn_solution
import mytorch.models.cnn as cnn
...
def test_upsampling_1d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/upsample_1d_res.npz',
        allow_pickle=True)
...
def test_downsampling_1d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/downsample_1d_res.npz',
        allow_pickle=True)
...
def test_upsampling_2d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/upsample_2d_res.npz',
        allow_pickle=True)
...
def test_downsampling_2d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/downsample_2d_res.npz',
        allow_pickle=True)
...
def test_convTranspose_1d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/convTranspose_1d_res.npz',
        allow_pickle=True)
...
def test_convTranspose_2d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/convTranspose_2d_res.npz',
        allow_pickle=True)
...
def test_MaxPool2d_stride1_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/maxpool2d_stride1_res.npz',
        allow_pickle=True)
...
def test_MaxPool2d_correctness():
    ...
    expected_res = np.load(
        './tests/test2/ref_result/maxpool2d_res.npz',
        allow_pickle=True)
...
def test_simple_scanning_mlp():
    data = np.loadtxt(
        os.path.join(
            './tests/test2', 'data', 'data.asc')).T.reshape(
        1, 24, -1)
